...
led_pins = (board.GP0, board.GP2, board.GP4, board.GP6,
            board.GP8, board.GP10, board.GP14) # board.GP8, board.GP10, board.GP12, board.GP14)

key_pins = (board.GP1, board.GP3, board.GP5, board.GP7,
            board.GP9, board.GP11, board.GP15) # board.GP9, board.GP11, board.GP13, board.GP15)
...
class Hardware():
    def __init__(self):
        ...
        # Next display part commented-out by @PaulskPt because we have already a display defined in code.py
        # DISPLAY
    ...
    def led_set(self,i,v):
        if i > len(self.leds)-1: return 0   # Added by @PaulskPt
        self.leds[i].duty_cycle = v * 256  # duty_cycle 0-65535

    # get LED brightness to value 0-255
    def led_get(self,i):
        if i > len(self.leds)-1: return 0  # Added by @PaulskPt
        #print(f"sequence_hardware.led_get(): i={i}")  # Line added by @PaulskPt
